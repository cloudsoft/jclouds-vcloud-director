...
public interface VCloudDirectorApi extends Closeable {
   ...
   /**
    * @return access to {@link OrgApi} features
    */
   @Delegate
   OrgApi getOrgApi();

   /**
    * @return access to {@link TaskApi} features
    */
   @Delegate
   TaskApi getTaskApi();

   /**
    * @return access to {@link NetworkApi} features
    */
   @Delegate
   NetworkApi getNetworkApi();

   /**
    * @return access to {@link CatalogApi} features
    */
   @Delegate
   CatalogApi getCatalogApi();

   /**
    * @return access to {@link MediaApi} features
    */
   @Delegate
   MediaApi getMediaApi();

   /**
    * @return access to {@link VdcApi} features
    */
   @Delegate
   VdcApi getVdcApi();
   ...
   /**
    * @return access to {@link VAppApi} features
    */
   @Delegate
   VAppApi getVAppApi();

   /**
    * @return access to {@link VAppTemplateApi} features
    */
   @Delegate
   VAppTemplateApi getVAppTemplateApi();

   /**
    * @return access to {@link VmApi} features
    */
   @Delegate
   VmApi getVmApi();
   
   /**
    * @return access to {@link MetadataApi} features
    */
   @Delegate
   ...
   /**
    * @return access to {@link AdminCatalogApi} admin features
    */
   @Delegate
   AdminCatalogApi getAdminCatalogApi();

   /**
    * @return access to admin {@link GroupApi} features
    */
   @Delegate
   GroupApi getGroupApi();

   /**
    * @return access to {@link AdminOrgApi} features
    */
   @Delegate
   AdminOrgApi getAdminOrgApi();

   /**
    * @return access to {@link UserApi} features
    */
   @Delegate
   UserApi getUserApi();

   /**
    * @return access to {@link AdminVdcApi} features
    */
   @Delegate
   AdminVdcApi getAdminVdcApi();

   /**
    * @return access to admin {@link AdminNetworkApi} features
    */
   @Delegate
